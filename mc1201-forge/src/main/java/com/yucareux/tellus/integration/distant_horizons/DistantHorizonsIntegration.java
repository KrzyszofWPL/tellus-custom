...
public final class DistantHorizonsIntegration {
   ...
   private static void registerStartupGateEvents() {
      STARTUP_GATE.reset();
      MinecraftForge.EVENT_BUS.addListener((ServerStartedEvent event) -> STARTUP_GATE.reset());
      MinecraftForge.EVENT_BUS.addListener((ServerStoppingEvent event) -> STARTUP_GATE.reset());
